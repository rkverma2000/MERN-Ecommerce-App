                        ...
                        <div className="m-1 w-75">
                            ...
                            <div className="md-3">
                                {photo ? (
                                    ...
                                    <div className="text-center">
                                        <img src={`${process.env.REACT_APP_API}/api/v1/product/product-photo/${id}`} alt='product' height='200px' className='img img-responsive' />
                                    </div>
                                )}
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                                <Select bordered={false}
                                    size='large'
                                    showSearch
                                    className='form-select mb-3 shipping-selector'
                                    placeholder={shipping ? 'Yes' : 'No'}
